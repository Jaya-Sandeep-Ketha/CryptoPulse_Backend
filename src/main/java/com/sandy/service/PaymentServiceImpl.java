...
import com.sandy.domain.PaymentOrderStatus;
import com.sandy.model.PaymentOrder;
import com.sandy.model.User;
import com.sandy.repository.PaymentOrderRepository;
...
public class PaymentServiceImpl implements PaymentService{
    ...
    public PaymentResponse createRazorpayPaymentLink(User user,
        ...
        try {
            ...
            paymentLinkRequest.put("callback_url","https://cryptopulse-trading.netlify.app/wallet/"+orderId);
    ...
    public PaymentResponse createStripePaymentLink(User user, Long amount,Long orderId) throws StripeException {
        ...
        SessionCreateParams params = SessionCreateParams.builder()
                ...
                .setSuccessUrl("https://cryptopulse-trading.netlify.app/wallet?order_id="+orderId)
                .setCancelUrl("https://cryptopulse-trading.netlify.app/cancel")
